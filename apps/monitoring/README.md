# Vulseek Monitoring (Go Version)

Application that powers Vulseek's monitoring service.
...
Vulseek uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
