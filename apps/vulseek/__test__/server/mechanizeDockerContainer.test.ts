...
import type { ApplicationNested } from "@vulseek/server/utils/builders";
import { mechanizeDockerContainer } from "@vulseek/server/utils/builders";
...
vi.mock("@vulseek/server/utils/servers/remote-docker", () => ({
