import type { Schema } from "@vulseek/server/templates";
import type { CompleteTemplate } from "@vulseek/server/templates/processors";
import { processTemplate } from "@vulseek/server/templates/processors";
