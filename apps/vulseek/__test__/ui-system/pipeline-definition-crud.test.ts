...
const document: PipelineDocumentV3 = {
	...
	stages: {
		discovery: {
			...
			mode: "serial",
			concurrency: 1,
			runtime: { kind: "agent", prompt: "Discover.", prepareRepository: "none", includePolicy: false, plugins: [] }, disableable: true, inputArtifacts: [], outputArtifacts: [], effects: [], containerNameParts: [], allowAgentExit: false, promptValues: {},
		...
		review: {
			...
			mode: "serial",
			concurrency: 1,
			runtime: { kind: "agent", prompt: "Review.", prepareRepository: "none", includePolicy: false, plugins: [] }, disableable: true, inputArtifacts: [], outputArtifacts: [], effects: [], containerNameParts: [], allowAgentExit: false, promptValues: {},
