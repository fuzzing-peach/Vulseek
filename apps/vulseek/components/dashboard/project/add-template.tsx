...
const TEMPLATE_BASE_URL_KEY = "vulseek_template_base_url";
...
export const AddTemplate = ({ environmentId, baseUrl }: Props) => {
	...
	// Cloud: show only if there are remote servers (no Vulseek option)
	// Self-hosted: show only if there are remote servers (Vulseek is default, hide if no remote servers)
							...
							>
								{templates?.map((template, idx) => (
									...
									>
										...
										>
											<img
												src={`${customBaseUrl || "https://templates.vulseek.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
														...
														{shouldShowServerDropdown && (
															<div>
																...
																<Select
																	...
																	defaultValue={
																		!isCloud ? "vulseek" : undefined
																	}
																>
																	<SelectTrigger>
																		<SelectValue
																			placeholder={
																				!isCloud ? "Vulseek" : "Select a Server"
																			}
																		/>
																	</SelectTrigger>
																	<SelectContent>
