...
Preserve distinct security-relevant module boundaries after removing obvious repository noise.
...
Apply the scan-repository skill's large-module splitting rules before writing module artifacts.
